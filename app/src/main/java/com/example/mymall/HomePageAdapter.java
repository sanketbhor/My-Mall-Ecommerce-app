...
public class HomePageAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        switch (viewType) {
            ...
            case HomePageModel.STRIP_ADD_BANNER:
                ...
                return new StripAdBanerViewholder(stripAdView);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        switch (homePageModelList.get(position).getType()) {
            ...
            case HomePageModel.STRIP_ADD_BANNER:
                ...
                ((StripAdBanerViewholder) viewHolder).setStripAd(resource, color);
                break;
    ...
    public class BannerSliderViewHolder extends RecyclerView.ViewHolder {
        ...
        public BannerSliderViewHolder(@NonNull View itemView) {
            super(itemView);
            bannerSliderViewPager = itemView.findViewById(R.id.product_images_view_pager);
        }
    ...
    public class StripAdBanerViewholder extends RecyclerView.ViewHolder {

        private ImageView stripAdImage;
        private ConstraintLayout stripAdContainer;

        public StripAdBanerViewholder(@NonNull View itemView) {
            super(itemView);
        ...
        private void setStripAd(String resource, String color) {
            Glide.with(itemView.getContext()).load(resource).apply(new RequestOptions().placeholder(R.mipmap.pet_food_advertise)).into(stripAdImage);
    ...
    public class HorizontalProductViewHolder extends RecyclerView.ViewHolder {
        ...
        public HorizontalProductViewHolder(@NonNull View itemView) {
            super(itemView);
            horizontalContainer = itemView.findViewById(R.id.horizontal_container);
    ...
    public class GridProductViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setGridProductLayout(final List<HorizontalProductScrollModel> horizontalProductScrollModelList, final String title, String color) {
            ...
            for (int x = 0;x < 4;x++){
                ...
                Glide.with(itemView.getContext()).load(horizontalProductScrollModelList.get(x).getProductImage()).apply(new RequestOptions().placeholder(R.mipmap.app_icon)).into(productImage);
