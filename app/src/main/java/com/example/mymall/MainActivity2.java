...
public class MainActivity2 extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.main_search_icon) {
            ...
            final Dialog signInDailog = new Dialog(MainActivity2.this);
            signInDailog.setContentView(R.layout.sign_in_dailogue);
            ...
            Button dailogSignInBtn = signInDailog.findViewById(R.id.dailog_sign_in_btn);
            Button dailogSignUpBtn = signInDailog.findViewById(R.id.dailog_sign_up_btn);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_my_mall) {
            ...
            // Handle the men action
        } else if (id == R.id.nav_beverages) {

        } else if (id == R.id.nav_dairy_and_bakery) {

        } else if (id == R.id.nav_snacks_and_branded_foods) {

        } else if (id == R.id.nav_beauty_and_hygiene) {

        } else if (id == R.id.nav_kitchen_staples) {

        } else if (id == R.id.nav_baby_care) {

        } else if (id == R.id.nav_pet_care) {
