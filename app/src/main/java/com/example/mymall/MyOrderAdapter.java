...
public class MyOrderAdapter extends RecyclerView.Adapter<MyOrderAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull MyOrderAdapter.Viewholder viewHolder, int position) {
        ...
        viewHolder.setData(resourse,title,deliveredDate,rating);
    }
    ...
    class Viewholder extends RecyclerView.ViewHolder {
        ...
        public Viewholder(@NonNull final View itemView) {
            ...
            deliveryStatus = itemView.findViewById(R.id.order_delivered_date_time);
        ...
        private void setData(int resources,String title, String deliveryDate,int rating) {
            ...
            if (deliveryDate.equals("Cancelled")) {
                ...
                orderIndicator.setImageTintList(ColorStateList.valueOf(itemView.getContext().getResources().getColor(R.color.successOrange)));
            }
